...
export default function RussiaRegionFilter({ onRegionChange }: RegionFilterProps) {
  ...
  useEffect(() => {
    const fetchRegions = async () => {
      try {
        const response = await fetch('https://amaranoc-4b1df-default-rtdb.firebaseio.com/RuRegions.json');
  ...
  return (
    <>
      <h3 className="h3leftcontent">Регион</h3>
