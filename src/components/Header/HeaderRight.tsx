  ...
  >
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        ...
        <p><strong>Ստեղծված:</strong> {user.metadata.creationTime || "Unknown"}</p>
        <p><strong>Վերջին մուտք:</strong> {user.metadata.lastSignInTime || "Unknown"}</p>
        ...
        >
          <i className="fa fa-sign-out" aria-hidden="true"></i> Դուրս գալ
        </button>
      </div>
    </div>
  </div>
